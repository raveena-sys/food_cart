...
class DrinkMasterController extends Controller
{
    ...
    {
        return view('store::manage-master.drink-master.index');
    }
    ...
    public function getDrinkMasterDetails($id)
    {
        try {
            ...
            return View::make('store::manage-master.drink-master.edit', ['detail' => $data])->render();
        } catch (\Exception $e) {
            return Response::json(['success' => false, 'message' => $e->getMessage()]);
        }
    }
    ...
    public function viewDrinkMaster($id)
    {
        ...
        return view('store::manage-master.drink-master.view', ['category' => $user]);
    }
