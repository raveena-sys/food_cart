    ...
    <div class="container-fluid">
        ...
        <div class="page-title-row filter-page-btn">
            ...
            <div class="right-side">
                ...
                <a href="{{ URL::To('store/product/add') }}" class="btn btn-danger ripple-effect text-uppercase">Add Product</a>
                @if(Auth::user()->user_type == 'store')
                <a href="javascript:void(0);" onclick="showSelectProducts()" class="btn btn-danger ripple-effect text-uppercase">Select Product</a>
       ...
       <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-libre-bold w-100 text-center product_price">Select Product to get in your Store</h4>
...
<script>
    (function categoryList() {
        let oTable = $('#category-listing').DataTable({
            ...
            ajax: {
                url: "{{url('store/product/list-data')}}",
                data: function(d) {
                    d.name = $('#name').val(),
                        d.status = $('#status').val()
                    //,d.type = 'appraiser'
    ...
    function showSelectProducts(id=''){
        $.ajax({
            ...
            success:function(response){
                $('.product_price').empty();
                $('.product_price').html('Select Product to get in your Store');
