    ...
    <div class="container-fluid">
        ...
        <div class="page-title-row filter-page-btn">
            <div class="left-side">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Special Menu</li>
                    </ol>
                </nav>
            ...
            <div class="right-side">
                ...
                <a href="{{ URL::To('store/manage-special-menu/add') }}" class="btn btn-danger ripple-effect text-uppercase">Add Special Menu</a>
       ...
       <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-libre-bold w-100 text-center product_price">Select Special Menu to get in your Store</h4>
