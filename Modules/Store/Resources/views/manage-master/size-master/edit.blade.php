<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body field-padd" id="edit-form">
            <form id="edit_category_form" action="{{url('store/manage-size-master/update')}}" method="POST" class="needs-validation" novalidate autocomplete="false">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    <label>value</label>
                    <input class="form-control" type="text" name="value" placeholder="value" value="{{$detail->value}}" maxlength="20">
                </div>
                <div class="form-group">
...
<script>
    function updateCategory() {
        ...
        if ($('#edit_category_form').valid()) {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('store/manage-size-master/update')}}",
                data: formData,
