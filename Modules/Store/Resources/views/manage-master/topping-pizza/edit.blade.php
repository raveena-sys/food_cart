<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title font-libre-bold w-100 text-center">Edit Topping Pizza</h4>
        ...
        <div class="modal-body field-padd" id="edit-form">
            ...
            <form id="edit_category_form" action="{{url('store/manage-pizza-size/update')}}" method="POST" class="needs-validation" novalidate autocomplete="false">
                ...
                <div class="form-group">
                        ...
                        @if($inputdisable)
                            <input type="hidden" name="food_type" value="{{$detail->food_type}}" maxlength="250" {{$inputreadonly}}>
                        @endif
                    </div>
            ...
            {!! JsValidator::formRequest('Modules\Admin\Http\Requests\EditToppingPizzaRequest','#edit_category_form') !!}
        </div>
    </div>
</div>
...
<script>
    function updateCategory() {
        ...
        if ($('#edit_category_form').valid()) {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('store/manage-topping-pizza/update')}}",
                data: formData,
