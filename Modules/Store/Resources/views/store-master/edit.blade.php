            ...
            <div class="left-side">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Store Details </li>
                    </ol>
                </nav>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="inner_cnt">
                    ...
                    <form id="add_category_form" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate autocomplete="false" action="{{URL::To('store/manage-store/update')}}">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input class="form-control" maxlength="250" name="email" type="text" value="{{$detail->email}}" placeholder="Email" readonly>
                        </div>

                        <div class="form-group">
                            <label>Phone number</label>
                            <input class="form-control" maxlength="50" name="phone_number" type="text" value="{{$detail->phone_number}}" placeholder="Phone number" readonly>
                        </div>
