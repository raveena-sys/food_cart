        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="inner_cnt">
                    ...
                    <form id="add_category_form" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate autocomplete="false" action="{{URL::To('store/orders/update')}}">
                        {{csrf_field()}}
...
<!-- 
 ...
 -->
                    ...
                    {!! JsValidator::formRequest('Modules\Store\Http\Requests\EditProductRequest','#add_category_form')
                    !!}
                </div>
