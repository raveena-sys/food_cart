    ...
    <div class="container-fluid">
        ...
        <div class="page-title-row filter-page-btn">
            <div class="left-side">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage Delivery</li>
                    </ol>
                </nav>
            ...
            <div class="right-side">
                ...
                <a href="{{url('store/manage-delivery/add')}}" class="btn btn-danger ripple-effect text-uppercase">Add Delivery Zone</a>
            </div>
        </div>
        <!-- Filter Start -->
                ...
                <table class="table" id="category-listing">
                    <thead>
                        <tr>
                            ...
                            <th><span class="sorting">Postal Code</span></th>
                            <th> Price ($)</th>
...
<script>
    (function deliveryList() {
        let oTable = $('#category-listing').DataTable({
            ...
            ajax: {
                url: "{{url('store/manage-delivery/list')}}",
                data: function(d) {
                    d.name = $('#name').val(),
                        d.status = $('#status').val(),
                        d.type = 'appraiser'
