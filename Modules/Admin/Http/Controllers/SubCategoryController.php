...
class SubCategoryController extends Controller
{
    ...
    {
        return view('admin::manage-master.sub-category.index');
    }
    ...
    public function getSubCategoryDetails($id)
    {
        try {
            ...
            return View::make('admin::manage-master.sub-category.edit', ['detail' => $data])->render();
        } catch (\Exception $e) {
            return Response::json(['success' => false, 'message' => $e->getMessage()]);
        }
    }
    ...
    public function viewSubCategory($id)
    {
        ...
        return view('admin::manage-master.sub-category.view', ['SubCategory' => $user]);
    }
