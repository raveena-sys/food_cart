...
class CmsController extends Controller
{
    ...
    {
        return view('admin::manage-cms.index');
    ...
    public function loadCmsList(Request $request) {
        ...
        $html = View::make('admin::manage-cms._list', ['cms' => $cms])->render();
        return Response::json(['success' => true, 'html' => $html]);
    }

    public function getCmsPageDetail($id){
        $editCms = $this->cms->showEditCms($id); // for show edit cms by cms id
        return view('admin::manage-cms.edit-cms', ['data' => $editCms]);
    }
    ...
    public function updateCmsPageDetail(Request $request){
        ...
        try{
            ...
            return redirect('/admin/manage-cms')->with($notification);
        } catch (\Exception $e) {
