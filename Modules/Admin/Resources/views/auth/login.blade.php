        ...
        <div class="login-wrap mx-auto position-relative">
            <div class="login common">
                <div class="logo text-center">
                    <input type="hidden" value="{{URL::To('admin/dashboard')}}" id="dashboard-url">
                    <a href="dashboard.php"><img src="{{ asset('img/logo_black.png')}}" class="logo" alt="logo"></a>
                </div>
                <h3 class="title">Log In</h3>
                <form id="loginForm" action="{{ url('admin/login') }}" method="post" class="needs-validation" novalidate autocomplete="false">
                    {{csrf_field()}}
