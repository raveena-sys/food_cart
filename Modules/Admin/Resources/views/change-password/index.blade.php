...
<main class="main-content add-page">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="inner_cnt">
                    <form id="change_password_form" action="{{ url('admin/update-password') }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="btn_row text-center">
                            <button id="change_password_button" class="btn btn-danger ripple-effect text-uppercase" data-url="{{URL::To('admin/update-password')}}">Update
