...
<!-- 
 ...
 -->
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="add_customisation_cart" checked="true" name="add_customisation" class="custom-control-input" value="0" @if($detail->add_customisation == '0') checked="true" @endif >
                                    <label class="custom-control-label" for="add_customisation_cart">Only Add To Cart</label>
                                </div>

                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="add_customisation_cust" name="add_customisation" class="custom-control-input" value="1" @if($detail->add_customisation == '1') checked="true" @endif >
                                    <label class="custom-control-label" for="add_customisation_cust">Only Customisation</label>
                                </div>

                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="add_customisation_both" name="add_customisation" class="custom-control-input" value="2" @if($detail->add_customisation == '2') checked="true" @endif >
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="topping_tops" name="topping_from" class="custom-control-input" value="topping_tops" @if($detail->topping_from == 'topping_tops') checked="true" @endif >
