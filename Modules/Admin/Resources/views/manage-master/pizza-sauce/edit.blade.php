<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body field-padd" id="edit-form">
            <form id="edit_category_form" action="{{url('admin/manage-pizzacrust/update')}}" method="POST" class="needs-validation" novalidate autocomplete="false">
                {{csrf_field()}}
...
<script>
    function updateCategory() {
        ...
        if ($('#edit_category_form').valid()) {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('admin/manage-pizza-sauce/update')}}",
                data: formData,
