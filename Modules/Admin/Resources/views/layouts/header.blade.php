<header id="header">
    ...
    <nav class="navbar justify-content-between">
        <div class="logo text-center">
            <a href="{{url('admin')}}"><img src="{{asset('img/logo_black.png')}}" class="logo"')}}" alt="logo"></a>
        </div>
        <ul class="nav right_nav d-flex align-items-center">
            ...
            <li class="nav-item dropdown user_info">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ URL::To('admin/profile-setting') }}">Profile Setting</a>
                    <a class="dropdown-item" href="{{ URL::To('admin/change-password') }}">Change Password</a>
                    <!-- <a class="dropdown-item" href="bank-account.php">Bank Account</a> -->
