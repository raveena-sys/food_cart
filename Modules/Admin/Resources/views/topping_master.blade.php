...
<main class="main-content add-page">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="inner_cnt">
                       <form id="toppingform" action="{{ url('admin/getData') }}"  method ="POST" enctype="multipart/form-data" >
                       {{csrf_field()}}
                       ...
                       {!! JsValidator::formRequest('Modules\Admin\Http\Requests\ToppingMasterRequest','#toppingform') !!}
                    </div>
                </div>
                <!-- xx -->
            </div>
...
{{-- <script>
    ...
    //    }
        ...
        var url = "{{url('admin/insert/getData')}}";
