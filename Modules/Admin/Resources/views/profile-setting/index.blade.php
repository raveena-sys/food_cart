...
<main class="main-content add-page">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="inner_cnt">
                    <form id="update_profile_form" action="{{ url('admin/profile-update') }}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                    ...
                    {!! JsValidator::formRequest('Modules\Admin\Http\Requests\UpdateProfileRequest','#update_profile_form') !!}
                </div>
            </div>
            <!-- xx -->
        </div>
