      ...
      <form method="post" id="custom_popup" name="custom_popup">
              ...
              <td>
                <div class="checkbox">
                  <label>
                    ...
                    {{$vtop5->name?$vtop5->name:''}} (${{$vtop5->custom_price?$vtop5->custom_price:'$0.00'}} )
                  </label>
                </div>
              </td>
            </tr>
        ...
        <div class="selectitemSlider">
          ...
          <div class="productItem">
            <input type="radio"  name="crust_master" id="crust_{{$v2->id?$v2->id:''}}"  value="{{$v2->id?$v2->id:''}}" data-price='{{$v2->custom_price?number_format($v2->custom_price,2):number_format($v2->price,2)}}' class="crust_master topping_wing_master">
