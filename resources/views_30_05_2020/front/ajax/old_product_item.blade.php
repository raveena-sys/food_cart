            ...
            <div class="card listGrid">
                <div class="imgWrapper">
                  ...
                  <div class="card-footer">
                    ...
                    @if($showCart)
                      <div class="countWrap">
                        <button type="button" id="sub" data-product_id="{{isset($val->id)?$val->id:0}}" data-price="{{isset( $price)? $price:0}}" class="sub sub_item" data-custom="{{isset($v['custom'])?1:0}}" data-sub="1">-</button>
                        ...
                        <button type="button" id="add" class="add add_item"
                            data-product_id="{{isset($val->id)?$val->id:''}}" data-price="{{isset( $price)? $price:0}}">+
                        </button>
                      </div>
                    @else
