        ...
        <table align="center" cellspacing="0" cellpadding="0" width="730" style="table-layout:fixed;margin:0 auto;border:1px solid #e0dfdf;border-collapse:collapse;padding:50px;font-family:Tahoma, Geneva, sans-serif; font-size:15px">
            ...
            <tr>
                <td valign="top" style="border:1px solid #e0dfdf; padding:15px;">
                    ...
                    <p style="margin-top: 0;">You have signup successfully ,please click on link to verify.</p>
                    <p  style="margin-top: 0;">Simply click <a href="{{!empty($data['link']) ? $data['link'] : ''}}" style="color: #fa4515;">here</a> to verify.</p>
            ...
            <tr bgcolor="#000">
                ...
                <span>Copyright &copy; {{date("Y")}} FoodCart. All Rights Reserved </span>
                </td>
            </tr>
            </tbody>
        </table>
